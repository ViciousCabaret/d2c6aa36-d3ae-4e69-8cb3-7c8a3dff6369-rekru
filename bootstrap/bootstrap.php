...
$container->set(\App\Service\Transformer\ProductTransformer::class, new \App\Service\Transformer\ProductTransformer());
...
$container->set(\App\Http\Controller\Product\GetProductController::class, new \App\Http\Controller\Product\GetProductController(
    ...
    $container->get(\App\Service\Transformer\ProductTransformer::class),
));
